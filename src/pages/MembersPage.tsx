    ...
    >
      ...
      >
        ...
        {isMobile ? (
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 32 }}>
            ...
            <a href="/executive-suite" style={{ color: C.navy, fontSize: 15, fontWeight: 500, textDecoration: "none" }}>Executive Suite</a>
      ...
      {isMobile && menuOpen && (
        <div style={{ background: C.white, borderTop: `1px solid ${C.lightgray}`, padding: "16px 24px 24px", display: "flex", flexDirection: "column", gap: 16 }}>
          ...
          <a href="/executive-suite" style={{ color: C.navy, fontSize: 16, fontWeight: 500, textDecoration: "none", padding: "4px 0" }}>Executive Suite</a>
