  ...
  return (
    <section style={{ position: "relative", width: "100%", minHeight: "90vh", fontFamily: font.body }}>
      ...
      <div style={{ position: "relative", zIndex: 1, display: "flex", flexDirection: "column", justifyContent: "flex-end", minHeight: "90vh", padding: "0 0 300px 7%" }}>
        <span style={{ fontFamily: font.display, fontWeight: 700, fontSize: 28, lineHeight: 1.05, letterSpacing: "-0.02em", color: "#5A1F28", display: "block", textShadow: "2px 2px 8px rgba(0,0,0,0.4)" }}>Women have always built businesses.</span>
