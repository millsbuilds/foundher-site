    ...
    <section style={{ background: C.cream, padding: "80px 24px", fontFamily: font.body }}>
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ overflow: "hidden" }}>
          ...
          <p style={{ fontSize: 16, color: C.taupe, lineHeight: 1.8, marginBottom: 20 }}>I've been a founder my entire adult life. My first job out of college was as the first employee and VP of Marketing at a video technology startup — back when movies on video and the machines to play them were the latest thing. We grew so fast we made the Inc. 500 three years in a row, and I quite accidentally became "a corporate executive of an Inc. 500 firm." It validated everything I believed about myself as a founder.</p>
          <p style={{ fontSize: 16, color: C.taupe, lineHeight: 1.8, marginBottom: 20 }}>For the next 30 years I pitched, built, and funded ventures across industries. Then came my last pitch — where a VC group told me I was too old to be a founder. So I walked away.</p>
          <p style={{ fontSize: 16, color: C.taupe, lineHeight: 1.8, marginBottom: 20 }}>For 12 years, I was done. Then AI arrived — and I couldn't stay on the sidelines.</p>
          <p style={{ fontSize: 16, color: C.taupe, lineHeight: 1.8, marginBottom: 20, fontStyle: "italic" }}>Hello, unretirement.</p>
